...
class Config:
    ...
    MONGO_URI = os.environ.get('MONGO_URI') or "mongodb+srv://prasannabollineni2:bollineni4266@cluster0.ngdtd.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
